...
Porta is an HTML-first starter designed for developers who want a clean foundation, not a framework demo.
...
Porta expects the following environment variable:
...
Porta is designed to pair naturally with:
